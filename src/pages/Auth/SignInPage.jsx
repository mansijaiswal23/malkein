...
export function SignInPage() {
  ...
  const [step, setStep] = useState("choose"); // "choose" | "otp"
  ...
  const handleVerifyOtp = () => {
    ...
    login({ name: "User", phone, avatar: null });
    navigate("/");
  };
    ...
    <div className="flex flex-col items-center min-h-screen">
      <div className="w-full max-w-xl mx-auto">
        ...
        <div className="bg-white mx-4 mt-5 rounded-2xl shadow-lg px-6 pt-6 pb-8">
          {step === "choose" && (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-5 border border-gray-200 rounded-lg py-2.5 text-sm text-gray-600 hover:bg-gray-50 transition mb-3"
              >
              ...
              <p className="text-center text-xs text-gray-400 mt-5">
                ...
                <button onClick={() => navigate("/sign-up")} className="text-[#DB0000] font-medium hover:underline">
                  Sign Up
                </button>
              </p>
              ...
              <p className="text-center text-[10px] text-gray-300 mt-2">
                ...
                <span className="text-[#DB0000]">Terms</span>
              </p>
            </>
          )}
          ...
          {step === "otp" && (
            <>
              <button onClick={() => setStep("choose")} className="text-gray-400 text-sm mb-4 hover:text-gray-600">← Back</button>
              <h2 className="text-center text-gray-800 font-semibold text-lg mb-1">OTP Verification</h2>
              <p className="text-center text-gray-400 text-xs mb-6">
                Enter OTP received on{" "}
                <span className="text-gray-600 font-medium">{phone.replace(/(\d{6})(\d{4})/, "XXXXXX$2")}</span>
              </p>
