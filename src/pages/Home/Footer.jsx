...
const PAYMENTS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 50 16" width="50" height="16" xmlns="http://www.w3.org/2000/svg">
        <text x="0" y="13" fontFamily="Arial" fontWeight="900" fontSize="14" fill="#1A1F71" letterSpacing="1">VISA</text>
      </svg>
    ),
  },
  {
  ...
  },
  {
    id: "upi",
    icon: (
      <svg viewBox="0 0 54 24" width="54" height="24" xmlns="http://www.w3.org/2000/svg">
        <polygon points="9,4 17,20 13,20 5,4" fill="#097939" />
        <polygon points="21,4 29,20 25,20 17,4" fill="#ED752E" />
        <text x="31" y="17" fontFamily="Arial" fontWeight="700" fontSize="10" fill="#097939">UPI</text>
      </svg>
    ),
  },
  {
    id: "paytm",
    icon: (
      <svg viewBox="0 0 56 24" width="56" height="24" xmlns="http://www.w3.org/2000/svg">
        <text x="0" y="17" fontFamily="Arial" fontWeight="800" fontSize="13" fill="#00BAF2">Pay</text>
        <text x="22" y="17" fontFamily="Arial" fontWeight="800" fontSize="13" fill="#002970">tm</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 72 24" width="72" height="24" xmlns="http://www.w3.org/2000/svg">
        <circle cx="10" cy="12" r="9" fill="#5F259F" />
        <text x="5" y="17" fontFamily="Arial" fontWeight="900" fontSize="13" fill="white">P</text>
        <text x="21" y="17" fontFamily="Arial" fontWeight="700" fontSize="11" fill="#5F259F">PhonePe</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 24" width="48" height="24" xmlns="http://www.w3.org/2000/svg">
        <rect x="7" y="6" width="20" height="14" rx="2" fill="none" stroke="#d97706" strokeWidth="1.5" />
        <circle cx="21" cy="13" r="3.5" fill="none" stroke="#d97706" strokeWidth="1.5" />
        <text x="2" y="10" fontFamily="Arial" fontWeight="700" fontSize="8" fill="#d97706">₹</text>
        <text x="30" y="17" fontFamily="Arial" fontWeight="700" fontSize="9" fill="#d97706">COD</text>
      </svg>
    ),
  },
];
        ...
        <div className="flex-1 min-w-full sm:min-w-75">
          ...
          <div className="flex flex-wrap gap-1 items-center">
            {PAYMENTS.map((p) => (
              <div
                key={p.id}
                className="bg-white border border-red-100 rounded-lg px-2 py-1 flex items-center justify-center h-10"
              >
                {p.icon}
              </div>
            ))}
